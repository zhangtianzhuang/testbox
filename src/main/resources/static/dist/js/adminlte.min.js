 ...
 */
/* cch 将n='[data-widget="todo-list"]',s="done"中的done删除，以取消todolist中的贯穿线效果*/
!function (t, e) {
    ...
    var e = function (t) {
        var e = "ControlSidebar", i = "lte.controlsidebar", n = t.fn[e],
            ...
            p = "layout-sm-navbar-fixed", _ = "layout-md-navbar-fixed", m = "layout-lg-navbar-fixed",
            v = "layout-xl-navbar-fixed", C = "layout-footer-fixed", y = "layout-sm-footer-fixed",
            b = "layout-md-footer-fixed", w = "layout-lg-footer-fixed", x = "layout-xl-footer-fixed",
            E = {controlsidebarSlide: !0, scrollbarTheme: "os-theme-light", scrollbarAutoHide: "l"}, A = function () {
                function e(t, e) {
                ...
                return n.collapse = function () {
                    ...
                    return this.each((function () {
                        var s = t(this).data(i), o = t.extend({}, E, t(this).data());
        ...
        var e = "Layout", i = t.fn[e], n = ".main-header", s = ".main-sidebar", o = ".main-sidebar .sidebar",
            a = ".content-wrapper", r = ".control-sidebar-content", l = '[data-widget="control-sidebar"]',
            c = ".main-footer", d = '[data-widget="pushmenu"]', h = ".login-box", f = ".register-box",
            u = "sidebar-focused", g = "layout-fixed", p = "control-sidebar-slide-open", _ = "control-sidebar-open",
            m = {
                ...
                return i.fixLayoutHeight = function (e) {
                    ...
                    var s = {
                        ...
                        control_sidebar: i
                    }, l = this._max(s), d = this._config.panelAutoHeight;
                    ...
                    return void 0 === i && (i = ""), this.each((function () {
                        var n = t(this).data("lte.layout"), s = t.extend({}, m, t(this).data());
        ...
        var e = "PushMenu", i = ".lte.pushmenu", n = t.fn[e], s = {COLLAPSED: "collapsed" + i, SHOWN: "shown" + i},
            ...
            a = '[data-widget="pushmenu"]', r = "body", l = "#sidebar-overlay", c = ".wrapper", d = "sidebar-collapse",
            h = "sidebar-open", f = "sidebar-closed", u = function () {
                function e(e, i) {
        ...
        var e = "Treeview", i = t.fn[e], n = {
            ...
            c = "sidebar-collapse", d = {
                ...
                return i.init = function () {
                    ...
                    return this.each((function () {
                        var n = t(this).data("lte.treeview"), s = t.extend({}, d, t(this).data());
        ...
        var e = "TodoList", i = t.fn[e], n = '[data-widget="todo-list"]', s = "", o = {
            onCheck: function (t) {
                return t
        ...
        var e = "CardWidget", i = ".lte.cardwidget", n = t.fn[e], s = {
                ...
                REMOVED: "removed" + i
            }, o = "card", a = "collapsed-card", r = "collapsing-card", l = "expanding-card", c = "was-collapsed",
            d = "maximized-card", h = {
                ...
                return i.collapse = function () {
                    ...
                    var n = t(this).data("lte.cardwidget"), s = t.extend({}, f, t(this).data());
        ...
        var e = "CardRefresh", i = t.fn[e], n = {
        ...
        }, s = "card", o = {CARD: "." + s, DATA_REFRESH: '[data-card-widget="card-refresh"]'}, a = {
            source: "",
            sourceSelector: "",
            params: {},
            ...
            return i.load = function () {
                ...
                var n = t(this).data("lte.cardrefresh"), s = t.extend({}, a, t(this).data());
        ...
        var e = "Dropdown", i = t.fn[e], n = ".navbar", s = ".dropdown-menu", o = ".dropdown-menu.show",
            a = '[data-toggle="dropdown"]', r = "dropdown-menu-right", l = {}, c = function () {
                function e(t, e) {
                    this._config = e, this._element = t
                }
                ...
                return i.toggleSubmenu = function () {
                    ...
                    if (0 !== e.length) {
                        ...
                        var i = e.offset(), n = e.width(), s = t(window).width() - i.left;
                        i.left < 0 ? (e.css("left", "inherit"), e.css("right", i.left - 5)) : s < n && (e.css("left", "inherit"), e.css("right", 0))
                    }
                }, e._jQueryInterface = function (i) {
                    return this.each((function () {
                        var n = t(this).data("lte.dropdown"), s = t.extend({}, l, t(this).data());
        ...
        var e = "Toasts", i = t.fn[e],
            ...
            h = "toasts-bottom-left", f = "topRight", u = "topLeft", g = "bottomRight", p = "bottomLeft", _ = {
                position: f,
                fixed: !0,
                autohide: !1,
                autoremove: !0,
                ...
                return i.create = function () {
                    ...
                    return this.each((function () {
                        var s = t.extend({}, _, n), o = new e(t(this), s);
                        "create" === i && o[i]()
                    }))
                }, e
            }();
